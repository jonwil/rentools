...
*/
#include "w3d.h"
TextureData *Textures; //the currently loaded textures
uint32 TextureCount = 0; //count of textures
...
void Initdefs()
{
	Textures = malloc(sizeof(TextureData));
	memset(Textures,0,sizeof(TextureData));
